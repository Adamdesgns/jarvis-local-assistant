...
class AIService {
  ...
  prompt(settings, context = {}) {
    ...
    return [
      ...
      '- File work he asks for happens directly: moving, copying, renaming and organizing inside his approved folders need no confirmation. You hold no file-mutation tools yourself, though — for phrasings that need one, tell him the exact command to say, like "move <file> to <folder>" or "delete <file>", and JARVIS carries it out.',
